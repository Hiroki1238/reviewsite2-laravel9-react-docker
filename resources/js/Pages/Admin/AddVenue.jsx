                ...
                <form onSubmit={handleSendPosts}>
                    ...
                    <div>
                        ...
                        <input
                            className="w-6/7 mb-6"
                            type="text"
                            placeholder="収容人数 (椅子使用時)  (例：41566)"
                        ...
                        <input
                            className="w-6/7 mb-6"
                            type="text"
                            placeholder="住所 (例：〒062-0045 北海道札幌市豊平区羊ケ丘１)"
                        ...
                        <select className="w-6/7 mb-6" type="number" onChange={(e) => setData("prefecture_id", e.target.value)}>
                        ...
                        <input
                            className="w-6/7 mb-6"
                            type="text"
                            placeholder="ホームページURL (例：https://www.sapporo-dome.co.jp/)"
