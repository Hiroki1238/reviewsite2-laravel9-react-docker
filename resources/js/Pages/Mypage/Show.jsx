...
const Index = (props) => {
  ...
  return (
    ...
    >
       ...
       <div className="h-48 w-48 my-0 mx-auto py-2 mb-6">
       ...
       <h2 className="text-title-purple1 text-2xl mt-3">ユーザー名</h2>
       <h3 className="text-my-gray1 text-xl">{auth.user.uname}</h3>
       <h2 className="text-title-purple1 text-2xl mt-3">年齢</h2>
       <h3 className="text-my-gray1 text-xl">{auth.user.age}代</h3>
       <h2 className="text-title-purple1 text-2xl mt-3">プロフィール</h2>
