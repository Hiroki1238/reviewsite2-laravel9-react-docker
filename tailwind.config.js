...
module.exports = {
    ...
    theme: {
        extend: {
            ...
            colors: {
                // 'カラー名': 'カラーコード'
                'link-blue': '#227cd6', 'dark-green': '#06bbbc', 'box-gray':'#eaeaea','my-gray1':'#494949', 'menutitle-gray': '#5b5b5b','menu-gray': '#686868', 'box-bordergray':'#c7c7c7', 'shadowgray1':'#bfbfbf', 'title-purple1':'#7a54a8','title-purple2':'#9780b5','my-purple2':'#884898', 'my-purple3':'#9969d3', 'my-purple4' : '#a06edd', 'green-white':'#f9ffff', 'bookmark-red':'#842530', 'gray-50': '#f9fbfc', 'gray-150': '#f4f5f7', 'gray-170': '#eff0f2', 'gray-250': '#eaebef',
              },
